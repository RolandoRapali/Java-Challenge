...
public class MateriaConfiguracion {
	...
	CommandLineRunner commandLineRunnerMateria(MateriaRepositorio materiaRepositorio) {
		return args -> {
			Materia matematicas = new Materia("Matematicas", LocalTime.of(8, 00),
					"una materia con muchos numeros y letras", 0, 10);
			Materia lengua = new Materia("Lengua", LocalTime.of(18, 00), "analisis de las palabras", 0, 10);
			Materia programacion = new Materia("Programacion", LocalTime.of(22, 00),
					"una materia donde se pueden construir programas", 0, 10);
